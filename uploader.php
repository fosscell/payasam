...
session_start();
if (!isset($_SESSION["type"]) || !($_SESSION["type"] == 'MN' || $_SESSION["type"] == 'PR'))
  exit();
/**
...
function createThumbGD($filepath, $thumbPath, $postfix, $maxwidth, $maxheight, $format='jpg', $quality=85)
{	
	...
	{
		if ($maxwidth>$width_orig || $maxheight>$height_orig) //+++Added+++
		{ $maxwidth = $width_orig; $maxheight = $height_orig; } //+++Added+++
